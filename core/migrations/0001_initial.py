# Generated by Django 5.2 on 2026-03-30 12:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lens', models.ForeignKey(help_text='The lens that defines the data source and constraints of the placement', on_delete=django.db.models.deletion.CASCADE, related_name='placements', to='core.lens')),
                ('scene', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='placements', to='core.scene')),
            ],
        ),
        migrations.CreateModel(
