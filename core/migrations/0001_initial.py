# Generated by Django 5.2 on 2026-04-02 15:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scale_factors', models.FloatField(blank=True, help_text='The scale factor of the data array', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rois', to='core.adataset')),
            ],
        ),
        migrations.CreateModel(
            name='Dataset',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_lens', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lineage_links', to='core.lens')),
                ('source_mask', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lineage_links', to='core.dataroi')),
                ('target_lens', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lineage_targets', to='core.lens')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='authentikate.client')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('source_mask', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.dataroi')),
                ('source_lens', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.lens')),
                ('target_lens', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.lens')),
                ('history_relation', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='provenance_entries', to='core.lineagelink')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('dataset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='meshes', to='core.dataset')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentikate.organization')),
                ...
                ('store', models.ForeignKey(blank=True, help_text='The store of the mesh', null=True, on_delete=django.db.models.deletion.CASCADE, to='datalayer.bigfilestore')),
            ],
        ),
        migrations.CreateModel(
            name='MetaSchema',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anchor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ome_metadata', to='core.coordinateanchor')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anchor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ome_plane_metadata', to='core.coordinateanchor')),
            ],
        ),
        migrations.CreateModel(
            name='OpticsView',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_color', models.JSONField(default=core.models.create_default_color, help_text='The base color of the channel (if using a mapped scaler) (RGBA)', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscenes', to='core.scene')),
            ],
        ),
        migrations.CreateModel(
            name='Layer',
            fields=[
                ...
                ('color', models.JSONField(default=core.models.create_default_color, help_text='The base color of the channel (if using a mapped scaler) (RGBA)', null=True)),
                ...
                ('lens', models.ForeignKey(help_text='The lens that defines the data source and constraints of the placement', on_delete=django.db.models.deletion.CASCADE, related_name='layers', to='core.lens')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.scene')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lens', models.ForeignKey(blank=True, db_constraint=False, help_text='The lens that defines the data source and constraints of the placement', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.lens')),
