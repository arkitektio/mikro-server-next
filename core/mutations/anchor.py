...
class CoordinateAnchorInput:
    ...
    dataset: ID = strawberry.field(description="The dataset this view belongs to")
    coords: dict = strawberry.field(
        description="The coordinates of the view. This is a dictionary that can contain any of the following keys: z_min, z_max, x_min, x_max, y_min, y_max, t_min, t_max, c_min, c_max. The values of these keys are the corresponding coordinates of the view. For example, if z_min is 10 and z_max is 20, then the view will include all z-slices from 10 to 20."
    )
