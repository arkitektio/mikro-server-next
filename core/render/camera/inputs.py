...
class CameraStateInput:
    ...
    cross_section_scale: float | None = strawberry.field(default=None, description="The flat view's zoom, in world units per screen pixel. Omit to leave it to the viewer")
    ...
    projection_scale: float | None = strawberry.field(default=None, description="The volumetric view's zoom, in world units per screen pixel. Omit to leave it to the viewer")
